...
<body class="is-boxed has-animations">
    <div class="body-wrap">
        <nav class="navbar navbar-expand-lg navbar-light bg-light" style="position: fixed;">
            ...
            <a class="navbar-brand" href="./landing.html">CRYPTOL</a>
                        ...
                        <div class="features-wrap">
                            <div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <p class="text-sm mb-0">Being one of the top concerns for any investors, we've made
                                        sure to provide world class security for all your transactions. Get a guaranteed
                                        no-comprimise on security with our regular audits from reknowed experts across
                                        the globe.</p>
                                </div>
                            </div>
                            <div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <p class="text-sm mb-0">Our infrastructre is capable of handling millions of
                                        transactions simultaneously with no errors left unchecked.</p>
                                </div>
                            </div>
                            <div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <p class="text-sm mb-0">Cryptol's simple design allows even a 5 year old to trade by
                                        intuition (Though we would not recommend it). Focus on conducting your trades
                                        and leave all the nitty gritty to us.</p>
                                </div>
                            </div>
                            <div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <p class="text-sm mb-0">Having trouble with your transactions? Reach out to us at
                                        any time to solve your issues quickly with our relaible support team.</p>
                                </div>
                            </div>
                            <div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <p class="text-sm mb-0">We guarantee that for every Dollar's worth of crypto you
                                        buy, We have a real Dollar to back it up. We've held this for over 7 years so
                                        rest assured, Invest your money without worries.</p>
                                </div>
                            </div>
                            <div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <p class="text-sm mb-0">We’re a team of hardcore traders & passionate blockchain
                                        believers. We understand exactly what you need. Powerful graphs, Security,
                                        Simplistic design and Convinience ; It's all here at Cryptol</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container-sm">
                    <div class="pricing-inner section-inner">
                        <div class="pricing-header text-center">
                            ...
                            <p class="section-paragraph mb-0">We offer only the best in Security, Speed and
                                Sophistication. Wanna know something even better? Cryptol is completely free to use. No
                                Overheads, No Hidden charges. Join us today and experience the world of cryptocurrencies
                                at its finest.</p>
                        </div>
